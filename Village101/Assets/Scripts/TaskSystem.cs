...
public class TaskSystem : MonoBehaviour
{
    ...
    void UnAssignedSetJob(List<Human> unAssignedPeople, Task theJob)
    {
        ...
        if (newPerson.dead)
        {
            ...
            UnAssignedSetJob(unAssignedPeople, theJob);


        }
        else
        {
            newPerson.SetJob(theJob);
        }
    ...
    void Start()
    {
        thisCommunity = GameObject.FindGameObjectWithTag("GameController").GetComponent<Community>();
